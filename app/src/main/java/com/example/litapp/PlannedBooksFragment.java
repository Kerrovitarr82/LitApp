...
public class PlannedBooksFragment extends Fragment {
    private DatabaseHelper databaseHelper;
    private SQLiteDatabase db;
    private Cursor bookCursor;
    private SimpleCursorAdapter bookAdapter;
    private ListView lvBooks;
    private FloatingActionButton btnAddBookPlan;

    public PlannedBooksFragment() {
        super(R.layout.fragment_planned_books);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnAddBookPlan = view.findViewById(R.id.btnAddBookPlan);


        btnAddBookPlan.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        lvBooks.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                inflater.inflate(R.menu.menu_popup_plan, popupMenu.getMenu());
    ...
    public void onResume() {
        ...
        db = databaseHelper.getReadableDatabase();
        bookCursor = db.rawQuery("select * from " + DatabaseHelper.TABLE+ " where " +
                DatabaseHelper.COLUMN_PLANNED + " = 1", null);
